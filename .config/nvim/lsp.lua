...
local status_ok = cmp_ok and cmp_lsp_ok and lspconfig_ok
...
local function lsp_keymaps(bufnr)
  ...
  -- vim.api.nvim_buf_set_keymap(bufnr, "n", "gr", "<cmd>lua telescope.lsp_references()<CR>", opts)
...
local servers = { 'pyright', 'clangd', 'tsserver', 'gopls', 'cssls', 'bashls', 'angularls', 'jdtls'}
